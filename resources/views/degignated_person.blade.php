...
<script src="http://bladephp.co/download/multiselect/jquery.multiselect.js"></script>
    ...
    <form action="/InsertData_new" method="post">
      ...
      <br>
      <br>
      relation_with_house_hold:<input type="text" name="relation_with_house_hold">
      <br>
      <br>
  ...
  <option value="{{ $occupation->occupation_id }}">{{ $occupation->occupation_desc }}</option>
    ...
    <br>
     <br>
      ...
      <br>
      <br>
      present_address:<input type="text" name="present_address">
      <br>
      <br>
